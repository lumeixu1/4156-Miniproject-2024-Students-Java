...
public class RouteController {
  ...
  public ResponseEntity<?> isCourseFull(@RequestParam String deptCode,
                                        @RequestParam int courseCode) {
    try {
  ...
  public ResponseEntity<?> findCourseLocation(@RequestParam String deptCode,
                                              @RequestParam int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> findCourseTime(@RequestParam String deptCode,
                                          @RequestParam int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> dropStudent(@RequestParam String deptCode,
                                       @RequestParam int courseCode) {
    try {
      boolean doesCourseExists;
      doesCourseExists = retrieveCourse(deptCode, courseCode).getStatusCode() == HttpStatus.OK;
  ...
  public ResponseEntity<?> setEnrollmentCount(@RequestParam String deptCode,
                                              @RequestParam int courseCode,
  ...
  public ResponseEntity<?> changeCourseTime(@RequestParam String deptCode,
                                            @RequestParam int courseCode,
  ...
  public ResponseEntity<?> changeCourseTeacher(@RequestParam String deptCode,
                                               @RequestParam int courseCode,
  ...
  public ResponseEntity<?> changeCourseLocation(@RequestParam String deptCode,
                                                @RequestParam int courseCode,
